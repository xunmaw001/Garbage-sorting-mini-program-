        ...
        <form class="app-update-pv">
            <view
                ...
                <input   disabled
                         ...
                         :disabled="ro.examredetailsUuidNumber" type="text" v-model="ruleForm.examredetailsUuidNumber" placeholder="知识问答试卷编号"></input>
            </view>
            <view
                    :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"88rpx"}'
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"#6a4826","textAlign":"left"}'
                      class="title">用户答案</view>
                <input   disabled
                         :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"#6a4826","borderRadius":"16rpx","color":"#6a4826","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.examredetailsMyanswer" type="text" v-model="ruleForm.examredetailsMyanswer" placeholder="用户答案"></input>
            </view>
                <view
                        :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"88rpx"}'
                        class="cu-form-group">
        ...
        methods: {
            ...
            async onSubmitTap() {
				if ((!this.ruleForm.examredetailsUuidNumber)) {
                    this.$utils.msg(`知识问答试卷编号不能为空`);
                    return
                }
				if ((!this.ruleForm.examredetailsMyanswer)) {
                    this.$utils.msg(`用户答案不能为空`);
                    return
                }
